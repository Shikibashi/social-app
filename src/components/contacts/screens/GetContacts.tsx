  ...
  return (
    <View style={[a.h_full]}>
      <Layout.Content
        ...
        <Text style={style}>
          <Trans>
            Edriffles helps friends find each other by creating an encoded
      ...
      <View
        ...
        <Text style={[a.text_sm, a.pb_xs]}>
          <Trans>
            I consent to Edriffles using my contacts for mutual friend discovery
...
function showPermissionDeniedAlert() {
  Alert.alert(
    ...
    t`You'll need to go to the System Settings for Edriffles and give permission if you want to use this feature.`,
    [
      {
        text: t`OK`,
        style: 'default',
