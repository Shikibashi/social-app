      ...
      <Dialog.ScrollableInner
        ...
        <View
          ...
          <Image
            ...
            alt={_(
              msg({
                message: `A screenshot of the post composer with a new button next to the post button that says "Drafts", with a rainbow firework effect. Below, the text in the composer reads "Hey, did you hear the news? Edriffles has drafts now!!!".`,
                comment:
