      ...
      <Dialog.ScrollableInner
        ...
        <View
          ...
          <Image
            ...
            alt={l({
              message: `Four message bubbles representing a group chat. First message: "Did you hear the news? Edriffles has group chats now!" Second message: "omg, no way" Third message: "Wow, 50 people in one chat!" Fourth message: "You can send invite links too!"`,
              comment:
        ...
        <View style={[a.px_xl, a.pt_2xl, a.gap_2xl]}>
          ...
          <View style={[a.gap_xl, a.pt_sm, a.pb_md]}>
            <Feature
              ...
              descriptionText={
                <Trans>Post it to Edriffles or share anywhere.</Trans>
              }
            />
            <Feature
              icon={GroupIcon}
